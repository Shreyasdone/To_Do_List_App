...
## Additional Notes
- **Database Initialization**: The [`setupDB`](controller/init.js#L38) function in [`controller/init.js`](controller/init.js) ensures that the required database and tables are created if they do not already exist.
